...
export default function ReviewLinkPage() {
  const [settings, setSettings] = useState<ReviewLinkSettings>(mockReviewLinkSettings);
  ...
  const isNegativeRating = selectedRating > 0 && selectedRating < settings.minRatingToRedirect;
        ...
        <main className="flex-1 overflow-auto bg-muted/30">
          <div className="p-3 sm:p-4 md:p-6 max-w-[1600px] mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
              <div>
                <h1 className="text-xl sm:text-2xl font-semibold tracking-tight">Review Link</h1>
              ...
              <div className="flex items-center gap-2">
                <Badge 
                  ...
                  className={cn(
                    "px-3 py-1",
                    settings.isActive && "bg-green-500/10 text-green-600 border-green-500/20"
                  )}
                >
                ...
                <Switch
                  ...
                  onCheckedChange={(checked: boolean) => updateSettings({ isActive: checked })}
                />
              </div>
            </div>

            {/* Main Layout - AI Builder Style */}
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 min-h-[calc(100vh-180px)]">
              {/* Settings Panel - Narrower sidebar */}
                ...
                <div className="rounded-xl bg-background border border-border/50 overflow-hidden">
                  ...
                  {activeStep === 1 && (
                    <div className="p-5 space-y-5">
                      <div>
                        <h3 className="text-base font-medium mb-1">Your Review Link</h3>
                        <p className="text-sm text-muted-foreground">Customize and share your unique review URL</p>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2 p-4 rounded-lg bg-muted/50 border border-border/50">
                          ...
                          <span className="flex-1 text-sm font-medium truncate">{reviewUrl}</span>
                          <Button
                            variant="ghost"
                            size="sm"
                            onClick={handleCopy}
                          ...
                          >
                            {copied ? (
                              <><Check className="h-4 w-4 text-green-500 mr-1.5" /> Copied</>
                            ) : (
                  ...
                  {activeStep === 2 && (
                    <div className="p-5 space-y-5">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Customize the look of your review page</p>
                      </div>
                      ...
                      <div className="space-y-5">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            <Label className="text-sm font-medium">Use Gradient Background</Label>
                            <Switch
                              checked={settings.useGradient}
                              onCheckedChange={(checked: boolean) => updateSettings({ useGradient: checked })}
                            />
                          </div>
                        </div>
                  ...
                  {activeStep === 3 && (
                    <div className="p-5 space-y-5">
                      <div>
                        <h3 className="text-base font-medium mb-1">Initial Page Content</h3>
                        <p className="text-sm text-muted-foreground">What customers see before rating</p>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="subheadline" className="text-sm font-medium">Subheadline</Label>
                          <Textarea
                            id="subheadline"
                            value={settings.subheadline}
                            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateSettings({ subheadline: e.target.value })}
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center justify-between py-1">
                              <span className="text-sm">Show business name</span>
                              <Switch
                                checked={settings.showBusinessName}
                                onCheckedChange={(checked: boolean) => updateSettings({ showBusinessName: checked })}
                              />
                            </div>
                            <div className="flex items-center justify-between py-1">
                              ...
                              <Switch
                                ...
                                onCheckedChange={(checked: boolean) => updateSettings({ showBusinessLogo: checked })}
                              />
                            </div>
                            <div className="flex items-center justify-between py-1">
                              ...
                              <Switch
                                ...
                                onCheckedChange={(checked: boolean) => updateSettings({ showBusinessAddress: checked })}
                              />
                            </div>
                          </div>
                        </div>
                  ...
                  {activeStep === 4 && (
                    <div className="p-5 space-y-5">
                      <div>
                        <h3 className="text-base font-medium mb-1">Rating Responses</h3>
                        <p className="text-sm text-muted-foreground">Customize what happens after a customer rates</p>
                      </div>
                      ...
                      <div className="space-y-4 p-4 rounded-lg bg-muted/30 border border-border/50">
                        ...
                        <Slider
                          ...
                          onValueChange={([value]: number[]) => updateSettings({ minRatingToRedirect: value })}
                          min={1}
                          max={5}
                          step={1}
                          className="w-full"
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <h4 className="text-sm font-medium">Positive Response ({settings.minRatingToRedirect}–5 stars)</h4>
                            <p className="text-xs text-muted-foreground">Redirect happy customers to Google</p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3 pl-10">
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => updateSettings({ positiveHeadline: e.target.value })}
                          ...
                          <div className="space-y-2">
                            ...
                            <Textarea
                              ...
                              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateSettings({ positiveSubheadline: e.target.value })}
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                onChange={(e) => updateSettings({ positiveCtaText: e.target.value })}
                            ...
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                onChange={(e) => updateSettings({ positiveRedirectUrl: e.target.value })}
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <h4 className="text-sm font-medium">Negative Response (1–{settings.minRatingToRedirect - 1} stars)</h4>
                            <p className="text-xs text-muted-foreground">Capture feedback privately</p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-3 pl-10">
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => updateSettings({ negativeHeadline: e.target.value })}
                          ...
                          <div className="space-y-2">
                            ...
                            <Textarea
                              ...
                              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => updateSettings({ negativeSubheadline: e.target.value })}
                          ...
                          <div className="flex items-center justify-between py-2">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm">Show feedback form</span>
                            </div>
                            <Switch
                              checked={settings.showFeedbackForm}
                              onCheckedChange={(checked: boolean) => updateSettings({ showFeedbackForm: checked })}
                            />
                          </div>

                          {settings.showFeedbackForm && (
                            <div className="space-y-2">
                              <Label className="text-sm">Feedback Placeholder</Label>
                              <Input
                                value={settings.feedbackPlaceholder}
                                onChange={(e) => updateSettings({ feedbackPlaceholder: e.target.value })}
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) => updateSettings({ negativeCtaText: e.target.value })}
                ...
                <div className="xl:sticky xl:top-20">
                  ...
                  <div
                    className={cn(
                      ...
                      previewMode === "mobile" ? "max-w-[300px]" : "max-w-full"
                    )}
                  >
                    {/* Device Frame */}
                    <div
                      className={cn(
                        ...
                        previewMode === "mobile"
                          ? "border-[8px] border-gray-900 dark:border-gray-700 shadow-xl"
                          : "rounded-xl border border-border/50 shadow-lg"
                      )}
                    >
                      {/* Notch for Mobile */}
                      {previewMode === "mobile" && (
                        <div className="h-6 bg-gray-900 dark:bg-gray-700 flex items-center justify-center">
                      ...
                      {/* Desktop Browser Bar */}
                      {previewMode === "desktop" && (
                        <div className="h-8 bg-gray-100 dark:bg-gray-800 border-b border-border/40 flex items-center px-3 gap-2">
                          ...
                          <div className="flex-1 mx-2">
                            <div className="h-5 bg-white dark:bg-gray-700 rounded-md text-[10px] flex items-center px-3 text-muted-foreground truncate">
                              {reviewUrl}
                            </div>
                          </div>
                        </div>
                      ...
                      <div
                        className={cn(
                          ...
                          previewMode === "mobile" ? "min-h-[520px]" : "min-h-[360px]"
                        )}
                        style={
                          settings.useGradient
                      ...
                      >
                        <div className="h-full flex flex-col items-center justify-center p-8 text-center">
                          ...
                          {settings.showBusinessLogo && (
                            <div
                              className="w-16 h-16 rounded-full mb-4 flex items-center justify-center text-white text-xl font-semibold shadow-lg"
                              style={{
                          ...
                          {/* Business Info */}
                          {(settings.showBusinessName || settings.showBusinessAddress) && (
                            <div className="mb-6">
                          ...
                          <div className="mb-6">
                            ...
                            <p
                              className={cn(
                                "text-xs leading-relaxed max-w-[240px] mx-auto",
                                settings.useGradient || settings.theme === "dark"
                                  ? "text-white/70"
                                  : "text-gray-500"
                              )}
                          ...
                          {isNegativeRating && settings.showFeedbackForm && (
                            <textarea
                              ...
                              className={cn(
                                "w-full max-w-[240px] h-24 p-3 rounded-xl text-xs resize-none mb-4 border-0 focus:ring-2 focus:ring-white/20 focus:outline-none",
                                settings.useGradient || settings.theme === "dark"
                          ...
                          {selectedRating > 0 && (
                            <button
                              className={cn(
                                "px-6 py-3 rounded-xl text-sm font-medium flex items-center gap-2 transition-all hover:scale-[1.02] active:scale-[0.98]",
                                settings.useGradient
                            ...
                            >
                              {isPositiveRating ? settings.positiveCtaText : settings.negativeCtaText}
                    ...
                    {previewMode === "mobile" && (
                      <div className="h-1 w-28 mx-auto mt-2 bg-gray-900 dark:bg-gray-700 rounded-full" />
                    )}
                  </div>
                  ...
                  {selectedRating > 0 && (
                    <div className="flex items-center justify-center gap-2 mt-4">
                      ...
                      <span className="text-xs text-muted-foreground">
                        {isPositiveRating ? "Positive" : "Negative"} response ({selectedRating} star{selectedRating !== 1 ? "s" : ""})
                      </span>
                    </div>
                  )}
                </div>
